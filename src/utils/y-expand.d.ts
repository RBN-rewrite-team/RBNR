...
declare function parseSequenceElement(
	s: string,
	i: number,
): Partial<LeafMountain> & { value: number; position: number; parentIndex: number };
declare function parseSequenceString(
	s: string,
): Array<Partial<LeafMountain> & { value: number; position: number; parentIndex: number }>;
...
export declare function calcMountain(
	s:
		| string
		| Array<Partial<LeafMountain> & { value: number; position: number; parentIndex: number }>
		| NodeMountain,
...
declare function findHighestWithPositionBelow(
	m: Mountain,
	sub: Mountain,
	position: number,
): Mountain | null;
export declare function wYexpand(
	s: string | Mountain,
	n: number,
	legBasedAscension?: boolean,
	stringify?: boolean,
): string | Mountain;
