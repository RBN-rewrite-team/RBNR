...
<p>每次非递归重置，非递归获取次数*{eff4}，上限*25</p>`,
	...
	'card.desc2': "再次确认！进入基数世界的隧道非常危险，强行提前进入可能造成严重影响，确定要进入吗？",
	'card.ultimatum': "最后警告",
	'card.desc3': '这是一份免责声明。 如果出了什么问题，<b>您的存档可能<i>永久</i>消失且<i>无法挽回</i></b>，这是您的责任。<br /><br />如果您同意这份免责声明，请在下面的输入框中输入“{verify}”。',
