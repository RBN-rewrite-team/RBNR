...
{id: 'news93', text:"0nan你也给自己照个项，出名要靠实力，无能狂怒解决得了问题，我狂"+"吠".repeat(3000)},
{id: 'news94', text:"您做的增量游戏没有人玩？醒醒吧，语言是逻辑基础，嘚叻吐噜嘚叻吐噜 哈呼！大舌头话都说明白，全是大舌音，还SYO，质物反湮灭，这些一大堆NaN你配吗！AI做的游戏败你a est limit et Ω_a est adm倍！现在好好学习，不成为滚木，将来比LHO混的不滚木，你连滚木的LHO都有，哈呼！呼！哈！呼！"},
{id: 'news95', text: "因为他们说序数是自然数,我说这是钻法律漏洞,应该实行英法联军。"}
] as const satisfies {
	id: string;
	text: string;
	unlocked?(): boolean;
