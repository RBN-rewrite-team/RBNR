...
<template>
  <div class="chapters-container">
    <div 
      v-for="(chapter, chapterKey) in SaveBank" 
      :key="chapterKey" 
      class="chapter-item"
    >
      <div 
        ...
        >
          <div v-if="isSaveItem(item)" class="save-content">
            ...
            <div class="save-container">
              <button class="btn download-btn-btn" @click="downloadSave(item['save-text'], chapter.title + ' - ' + item.title)">
                下载存档
              </button>
