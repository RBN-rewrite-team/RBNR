import { BoxGameObject, GuardGameObject, WallGameObject, type GameObject } from './game-object';
	...
	return [
		{
			map: [
				...
				convertStringToMap('W00PWW000WPW000WWWPWWWWPWW', [new BoxGameObject(1)]),
				convertStringToMap('WWWWWWPWWWWWW0WW00000W0P0W', [new GuardGameObject()]),
