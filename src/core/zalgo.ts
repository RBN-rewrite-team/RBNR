			...
			.map((a) => {
				...
				for (let i = 0; i < level; i++) {
					...
					if (Zalgo.random(10, seed++) / 10 >= 0.5)
						a +=
							Zalgo.chars[rand as keyof typeof Zalgo.chars][
								Zalgo.random(
									Zalgo.chars[rand as keyof typeof Zalgo.chars].length,
									seed++,
								)
							];
				}
