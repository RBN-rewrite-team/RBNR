		...
		<>
			{mapping[0].map((g) => (
				<>
					...
					>
						<h2 style="position: relative; bottom: -80px">{g.name}</h2><h3 style="position: absolute; top: -30px">x{formatWhole(player.garden.generators[g.key as unknown as any])}</h3>
						<br />
