...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        return ()=>(
            <>
                <div class={"main"}  onMousedown={onMousedown} onTouchstart={onTouchstart} onMouseup={onMouseup} onTouchend={onTouchend}
                    onTouchmove={onTouchmove} onMousemove={onMousemove} id="canvas" ref={canvasRef}>
                    何意味。
                    <div class={"canvas_corner"}>
                        <div 
                            class="node" 
                            style={{...getNodeStyle(0,0), borderColor: "white"}}
                            >
