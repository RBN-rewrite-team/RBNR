...
export const Multiplication = {
  initMechanics() {
    UPGRADES.create('31', {
      ...
      get requirement() {
        return [['获得1乘法能量', () => player.multiplication.totalMulpower.gte(1)] as singleReq];
      },
      show: function () {
        return true;
      },
    ...
    UPGRADES.create('32', {
      description: '30系列升级购买数量的平方同样作用于U12的效果',
      currency: '乘法能量',
      cost: new Decimal(2),
      canAfford() {
        return player.multiplication.mulpower.gte(this.cost);
      ...
      get requirement() {
        return [['获得2乘法能量', () => player.multiplication.totalMulpower.gte(2)] as singleReq];
      },
      show: function () {
        return true;
      },
    ...
    UPGRADES.create('33', {
      ...
      get requirement() {
        return [['获得3乘法能量', () => player.multiplication.totalMulpower.gte(3)] as singleReq];
      },
      show: function () {
        return true;
      },
    ...
    UPGRADES.create('34', {
      ...
      get requirement() {
        return [['获得47乘法能量', () => player.multiplication.totalMulpower.gte(47)] as singleReq];
      },
      show: function () {
        return true;
      },
    ...
    UPGRADES.create('35', {
      ...
      get requirement() {
        return [['获得1,000,000乘法能量', () => player.multiplication.totalMulpower.gte(1000000)] as singleReq];
      },
      show: function () {
        return true;
      },
