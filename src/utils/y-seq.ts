...
export const Y_Milestones: [Decimal, string, ...string[]][] = [
	...
	[
		new Decimal(600),
		'Y(1,2,4,8,12,16,16,16)',
		'ψ(N_ω)',
		'(0,0,0)(1,1,1)(2,1,1)(3,1,1)(3,1,1)(3,1,1)',
		'SNO',
	],
	[
		new Decimal(640),
		'Y(1,2,4,8,12,16,19,23)',
		'ψ(2\\textrm{ aft }3)',
	...
	[
		new Decimal(2 ** 53),
		'Y(1,3,4,2,5,7,11,13,17,19,22,5)',
		'(0)(1^{ω+1})(2,1^ω)(3,2^ω,1)(4,1^ω)(5,2^ω)',
	],
	...
	[
		new Decimal(2 ** 56),
		'Y(1,3,4,2,5,7,11,14,16,5)',
		'(0)(1^{ω+1})(2,1^ω)(3,2^ω,1)(4,2^ω)(5,1^ω)',
	],
	[
		new Decimal(2 ** 57),
		'Y(1,3,4,2,5,7,11,14,17,5)',
		'(0)(1^{ω+1})(2,1^ω)(3,2^ω,1)(4,2^ω)(5,2^ω)',
	],
	[
		new Decimal(2 ** 58),
		'Y(1,3,4,2,5,7,11,14,18,5)',
		'(0)(1^{ω+1})(2,1^ω)(3,2^ω,1)(4,2^ω)(5,3^ω)',
	],
	[
		new Decimal(2 ** 59),
		'Y(1,3,4,2,5,7,11,14,19)',
		'(0)(1^{ω+1})(2,1^ω)(3,2^ω,1)(4,2^ω)(5,3^ω,1)',
	],
	[new Decimal(2 ** 60), 'Y(1,3,4,2,5,7,11,15)', '(0)(1^{ω+1})(2,1^{ω+1})'],
	[new Decimal(2 ** 61), 'Y(1,3,4,2,5,7,11,15,17,5)', '(0)(1^{ω+1})(2,1^{ω+1})(3,1^ω)'],
	[
		new Decimal(2 ** 62),
		'Y(1,3,4,2,5,7,11,15,18)',
		'(0)(1^{ω+1})(2,1^{ω+1})(3,1^ω)(4,2^{ω+1})(5,2^{ω+1})(6,2)',
	],
...
export const getCurrentYMilestone = (target: Decimal) =>
	Y_Milestones[getCurrentYMilestoneIndex(target)];

console.log(Y_Milestones);
