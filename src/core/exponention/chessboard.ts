...
function getMCB6Effect() {
  return player.exponention.exppower.div(1e40).max(1).root(4).mul(4).sub(3).add(1)
...
export function wgEffect() {
  ...
  if(player.milestones.cb19) eff5 = new Decimal(1).div(wg.add(1).ln().mul(1.5).add(1).iteratedlog(10, 0.5).add(1))
  let scp = [0.5, 0.4, 0.3];
  ...
  if (eff5.lt(1 / 3) && !player.milestones.cb19) eff5 = new Decimal(1).div(new Decimal(1).div(eff5).sub(2).pow(0.5).add(2)).max(0.25)
